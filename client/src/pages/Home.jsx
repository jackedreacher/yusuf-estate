    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        YusufEmlak birsonraki mükemmel evinizi bulmanız için şimdiye kadar kurulmuş en iyi emlakçılık sitesi.
          <br />
          Aralarından seçim yapabileceğiniz yüzlerce farklı mülkü sizlerle buluşturuyoruz.
        </div>
        <Link
          to={'/search'}
        ...
        {rentListings && rentListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm text-blue-800 hover:underline' to={'/search?type=rent'}>Kiralık daha fazla yer göster</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
